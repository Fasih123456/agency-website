  ...
  return (
    <>
      <section
        ...
        style="background-image: url(https://www.winwinit.eu/wp-content/uploads/2021/05/Consulting.jpg)"
      >
        <div className="inner-frame">
          <header data-aos="fade-up" className="aos-init aos-animate">
          ...
          <div className="support__wrap">
            <div className="support__illustration">
              <img
                alt="Womans profile"
                className="support__img-left lazy aos-init loaded aos-animate"
                data-aos="fade-in"
                data-aos-delay="100"
              ...
              <img
                ...
                className="support__img-right lazy aos-init loaded aos-animate"
                data-aos="fade-in"
                data-aos-delay="300"
                data-ll-status="loaded"
            ...
            <div className="support__list">
              ...
              <div className="support__cta aos-init aos-animate" data-aos="fade-up"></div>
            </div>
          </div>
        </div>
      </section>
